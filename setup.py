...
setup(
    ...
    extras_require={"dev": ["autoflake==1.*,>=1.3.1", "black==21.*,>=21.12.0.b0", "codecov==2.*,>=2.0.16", "dephell==0.*,>=0.8.3", "flake8==4.*,>=4.0.1", "freezegun==1.*,>=1.1.0", "isort==5.*,>=5.10.1", "mypy==0.*,>=0.930.0", "pyproject-flake8==0.*,>=0.0.1.a2", "pytest==6.*,>=6.2.5", "pytest-cov==3.*,>=3.0.0", "tomlkit==0.7.0", "types-freezegun==1.*,>=1.1.3", "types-python-dateutil==2.*,>=2.8.4"]},
)
